    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleFormControlInput1" type="url" name="link"
                            placeholder="Link" value="{{ $page->link }}">
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-5 col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label" for="formFile">page Image</label>
                        <input class="form-control" id="formFile" type="file" name="banner">
                        <img class="img-fluid" src="{{ asset('/storage/'.$page->banner)}}" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="card my-3">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input id="x" type="hidden" name="description" value="{{ $page->description }}">
